...
public class CameraSource {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mBarcodeReader = new BarcodeReader("703FFB7658F9B13C0BE779C719A80532");
        }
        ...
        public Builder setBarcodeFormat(long barcodeFormat) {
            mCameraSource.mBarcodeFormat = barcodeFormat;
            return this;
        }
        ...
        public CameraSource build() {
            mCameraSource.mFrameProcessor = mCameraSource.new FrameProcessingRunnable(mBarcodeReader);
    ...
    private class FrameProcessingRunnable implements Runnable {
        private com.dynamsoft.barcode.BarcodeReader mDetector;
        ...
        FrameProcessingRunnable(com.dynamsoft.barcode.BarcodeReader detector) {
            mDetector = detector;
        }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    Log.e("dbr", "Dynamsoft time cost: " + (SystemClock.currentThreadTimeMillis() - t));
